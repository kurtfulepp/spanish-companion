...
export function DailyLessonDialog({ open, onOpenChange, level, onComplete }: { open: boolean; onOpenChange: (open: boolean) => void; level: string; onComplete: () => void | Promise<void> }) {
