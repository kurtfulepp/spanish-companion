...
const futureThemes = [
  { title: 'Around the City', description: 'Directions, neighborhoods, errands, and getting around.', image: '/vocabulary/around-the-city.png', tone: 'bg-[#e7f1f8]' },
  { title: 'Travel', description: 'Airports, hotels, changes of plan, and useful requests.', image: '/vocabulary/travel.png', tone: 'bg-[#e9f6f0]' },
  { title: 'Social Life', description: 'Plans, invitations, stories, and natural reactions.', image: '/vocabulary/social-life.png', tone: 'bg-[#fff1ed]' },
  { title: 'Work & Meetings', description: 'Ideas, updates, decisions, and polite disagreement.', image: '/vocabulary/work-meetings.png', tone: 'bg-[#eef0fb]' },
  { title: 'Home & Daily Life', description: 'Routines, repairs, neighbors, and everyday details.', image: '/vocabulary/home-daily-life.png', tone: 'bg-[#fff4dc]' },
  { title: 'Feelings & Relationships', description: 'Nuance, support, boundaries, and connection.', image: '/vocabulary/feelings-relationships.png', tone: 'bg-[#fbecef]' },
];
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      const [{ data: themeData }, { count }] = await Promise.all([
        supabase.from('vocabulary_themes').select('id, title, description').eq('id', 'dining-out').maybeSingle(),
