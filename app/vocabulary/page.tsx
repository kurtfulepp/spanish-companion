...
import { ArrowRight, BookOpen, Camera, Check, Sparkles, Upload } from 'lucide-react';
...
export default function VocabularyPage() {
  ...
  const updateProfile = useCallback((next: Parameters<typeof setProfile>[0]) => setProfile(next), [setProfile]);
  ...
  <section className="brand-action-panel mx-auto mt-8 max-w-[1360px]" aria-labelledby="photo-vocabulary-title">
    <div className="brand-action-art"><img src={KURTES_ILLUSTRATIONS.photoVocabulary.src} alt="" width={256} height={256} /></div>
    <div className="brand-action-copy">
      <h2 id="photo-vocabulary-title">CREATE YOUR OWN</h2>
      <p>Upload a photo to create a custom theme to enhance your vocabulary.</p>
    </div>
