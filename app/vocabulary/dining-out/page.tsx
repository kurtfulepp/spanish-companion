...
export default function DiningOutPage() {
  ...
  return <main className="min-h-screen bg-background px-3 pb-12 pt-3 text-foreground sm:px-5"><VocabularyHeader profile={profile} onProfileChange={updateProfile} />
    <div className="mx-auto mt-5 max-w-[1360px]"><Link href="/vocabulary" className="inline-flex items-center gap-2 rounded-full px-3 py-2 text-sm font-semibold text-muted-foreground transition hover:bg-white hover:text-foreground"><ArrowLeft className="size-4" />All vocabulary themes</Link></div>
